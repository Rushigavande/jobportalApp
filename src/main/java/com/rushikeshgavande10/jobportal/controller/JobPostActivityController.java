...
import com.rushikeshgavande10.jobportal.entity.*;
import com.rushikeshgavande10.jobportal.services.JobPostActivityService;
import com.rushikeshgavande10.jobportal.services.JobSeekerApplyService;
...
public class JobPostActivityController {
    ...
    public String updateJob(@PathVariable("id") int id, JobPostActivity jobPostActivity) {
        JobPostActivity existingJob = jobPostActivityService.getOne(id);
        if (existingJob != null) {
            jobPostActivity.setJobPostId(id);
            jobPostActivity.setPostedById(existingJob.getPostedById());
            jobPostActivity.setPostedDate(existingJob.getPostedDate());
            
            if (jobPostActivity.getJobLocationId() != null) {
                jobPostActivity.getJobLocationId().setId(existingJob.getJobLocationId().getId());
            }
            if (jobPostActivity.getJobCompanyId() != null) {
                jobPostActivity.getJobCompanyId().setId(existingJob.getJobCompanyId().getId());
            }
